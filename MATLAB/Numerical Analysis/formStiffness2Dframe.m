function [stiffness]=formStiffness2Dframe(GDof,numberElements,elementNodes,numberNodes,xx,yy,EI,EA)
...
oneu3=[1 1;-1 -1];
oneu4=[4 2;2 4];
k1=[EA/ll*oneu zeros(2,4);zeros(2) 12*EI/ll^3*oneu 6*EI/ll^2*oneu3;zeros(2) 6*EI/ll^2*oneu2 EI/ll*oneu4];
disp(k1)
