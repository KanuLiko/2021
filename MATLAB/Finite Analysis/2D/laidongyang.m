...
elementNodes=[1 2;2 3;3 4;4 5;1 5;2 5;3 5];
nodeCoordinates=[0 0;0.5 0.5;1.5 0.5;2 0;1 0];
...
% clf
hold on
drawingTrussMesh(nodeCoordinates+1e6*scaleFact*[XX YY],elementNodes,'g.',20,'k',2);
